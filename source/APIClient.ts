...
import { IJobOrder, IRecipe, IJobInfo, IJobReport, TTaskState } from "./types";
...
export default class ApiClient
{
    ...
    async createJobUploadFiles(jobId: string, recipeId: string, parameters: IParameters): Promise<any>
    {
    ...
    validateParameters(recipe: IRecipe, parameters: IParameters)
    {
    ...
    extractFiles(recipe: IRecipe, parameters: IParameters): string[]
    {
        const files = [];
